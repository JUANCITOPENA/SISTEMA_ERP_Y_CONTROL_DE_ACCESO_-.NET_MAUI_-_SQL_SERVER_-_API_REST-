...
> 💡 **Matemática del Inventario:** El sistema no guarda el "Stock Inicial" estáticamente para siempre. En su lugar, usa la vista SQL w_ReporteInventario para calcular dinámicamente: Stock Inicial = Stock Actual + Total de Salidas. Así siempre existe una trazabilidad perfecta sin desincronizaciones en la BD.
